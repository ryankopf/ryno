module Rhino
  class Page < ApplicationRecord
    ...
    def render_content(request)
      @no_edit_button = true
      self.rendered_content = ApplicationController.new.render_to_string(partial: 'rhino/pages/show', locals: { page: self, request: request, no_edit_button: @no_edit_button })
